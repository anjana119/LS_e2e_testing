//  To test this content ->  npm tag test : npm test -- --tag redirectToSuccessPageTestAustralia

const DefaultConfig = require('../DefaultConfig.json');

module.exports = {
    '@tags': ['redirectToSuccessPageTestAustralia'],
    'Luxury Escapes Pay Securely Test Australia'(browser) {
        ...
        const emailAddressFieldTraveller2 = 'input[data-testid="passenger-email-1"]';
        ...
        const fullNameFieldPaymentsDetails = 'input[name="ccname"]';
    ...
    ;
        ...
        browser.element('css selector', selectFlightCategory, function (result) {
            if (result.status === -1) {
                ...
                browser
                    ...
                    .setValue(emailAddressFieldTraveller2, DefaultConfig.email_Address_Traveller_2)
                ...
                browser.waitForElementPresent(airlineBookingReferenceNoSection, 50000, 'Airline Booking Reference No is present !');
        ...
        browser.saveScreenshot('tests_output/screenshots/australia/RedirectToSuccessPageTestAustralia.png');
    }
};