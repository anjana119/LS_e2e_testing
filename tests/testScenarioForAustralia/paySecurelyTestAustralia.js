//  To test this content ->  npm tag test : npm test -- --tag paySecurelyTestAustralia

const DefaultConfig = require('../DefaultConfig.json');

module.exports = {
    '@tags': ['paySecurelyTestAustralia'],
    'Luxury Escapes Pay Securely Test Australia'(browser) {
        ...
        browser.saveScreenshot('tests_output/screenshots/australia/PaySecurelyTestAustralia.png');
    }
};