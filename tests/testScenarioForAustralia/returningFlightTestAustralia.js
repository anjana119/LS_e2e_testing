//  To test this content ->  npm tag test : npm test -- --tag returningFlightTestAustralia

const DefaultConfig = require('../DefaultConfig.json');

module.exports = {
    '@tags': ['returningFlightTestAustralia'],
    ...
    ;
        ...
        browser.saveScreenshot('tests_output/screenshots/australia/ReturningFlightTestAustralia.png');
    }
};