//  To test this content ->  npm tag test : npm test -- --tag continueFunctionTestHongKong

const DefaultConfig = require('../DefaultConfig.json');

module.exports = {
    '@tags': ['continueFunctionTestHongKong'],
    ...
    ;
        ...
        browser.saveScreenshot('tests_output/screenshots/hongKong/ReviewAndPaymentPageHongKong.png');
    }
};