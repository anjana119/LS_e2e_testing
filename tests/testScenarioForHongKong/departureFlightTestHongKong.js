//  To test this content ->  npm tag test : npm test -- --tag departureFlightTestHongKong

const DefaultConfig = require('../DefaultConfig.json');

module.exports = {
    '@tags': ['departureFlightTestHongKong'],
    'Luxury Escapes Departure Flight Test HongKong'(browser) {
...
;
        ...
        browser.saveScreenshot('tests_output/screenshots/hongKong/DepartureFlightTestHongKong.png');
    }
};