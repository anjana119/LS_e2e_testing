//  To test this content ->  npm tag test : npm test -- --tag redirectToSuccessPageTestHongKong

const DefaultConfig = require('../DefaultConfig.json');

module.exports = {
    '@tags': ['redirectToSuccessPageTestHongKong'],
    'Luxury Escapes Redirect To Success Page Test HongKong'(browser) {
