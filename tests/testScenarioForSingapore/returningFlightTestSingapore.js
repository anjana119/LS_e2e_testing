//  To test this content ->  npm tag test : npm test -- --tag returningFlightTestSingapore

const DefaultConfig = require('../DefaultConfig.json');

module.exports = {
    '@tags': ['returningFlightTestSingapore'],
    ...
    ;
        ...
        browser.saveScreenshot('tests_output/screenshots/singapore/ReturningFlightTestSingapore.png');
    }
};