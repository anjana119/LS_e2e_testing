//  To test this content ->  npm tag test : npm test -- --tag departureFlightTestSingapore

const DefaultConfig = require('../DefaultConfig.json');

module.exports = {
    '@tags': ['departureFlightTestSingapore'],
    'Luxury Escapes Departure Flight Test Singapore'(browser) {
    ...
    ;
        ...
        browser.saveScreenshot('tests_output/screenshots/singapore/DepartureFlightTestSingapore.png');
    }
};