//  To test this content ->  npm tag test : npm test -- --tag redirectToSuccessPageTestSingapore

const DefaultConfig = require('../DefaultConfig.json');

module.exports = {
    '@tags': ['redirectToSuccessPageTestSingapore'],
    ...
    ;
        ...
        browser.saveScreenshot('tests_output/screenshots/singapore/redirectToSuccessPageTestSingapore.png');
    }
};