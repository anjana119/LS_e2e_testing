//  To test this content ->  npm tag test : npm test -- --tag continueFunctionTestUnitedStates

const DefaultConfig = require('../DefaultConfig.json');

module.exports = {
    '@tags': ['continueFunctionTestUnitedStates'],
    'Luxury Escapes Returning Flight Test UnitedStates'(browser) {
    ...
    ;
        ...
        browser.saveScreenshot('tests_output/screenshots/unitedStates/ReviewAndPaymentPageUnitedStates.png');
    }
};