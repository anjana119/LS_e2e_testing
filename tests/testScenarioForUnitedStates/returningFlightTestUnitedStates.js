//  To test this content ->  npm tag test : npm test -- --tag returningFlightTestUnitedStates

const DefaultConfig = require('../DefaultConfig.json');

module.exports = {
    '@tags': ['returningFlightTestUnitedStates'],
    ...
    ;
        ...
        browser.saveScreenshot('tests_output/screenshots/unitedStates/ReturningFlightTestUnitedStates.png');
    }
};