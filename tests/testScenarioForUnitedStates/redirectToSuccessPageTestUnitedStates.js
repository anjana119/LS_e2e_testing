//  To test this content ->  npm tag test : npm test -- --tag redirectToSuccessPageTestUnitedStates

const DefaultConfig = require('../DefaultConfig.json');

module.exports = {
    '@tags': ['redirectToSuccessPageTestUnitedStates'],
    'Luxury Escapes Redirect To Success Page Test UnitedStates'(browser) {
    ...
    ;
        ...
        browser.saveScreenshot('tests_output/screenshots/unitedStates/RedirectToSuccessPageTestUnitedStates.png');
    }
};