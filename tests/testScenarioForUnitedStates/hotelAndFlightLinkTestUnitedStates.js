//  To test this content ->  npm tag test : npm test -- --tag luxuryEscapesUrlTestUnitedStates

const DefaultConfig = require('../DefaultConfig.json');

module.exports = {
    '@tags': ['luxuryEscapesUrlTestUnitedStates'],
    'Luxury Escapes Url Test UnitedStates'(browser) {
        ...
        browser
            ...
            .saveScreenshot('tests_output/screenshots/unitedStates/HotelReservationPageUnitedStates.png');
    }
};