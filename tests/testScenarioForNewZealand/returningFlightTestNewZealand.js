//  To test this content ->  npm tag test : npm test -- --tag returningFlightTestNewZealand

const DefaultConfig = require('../DefaultConfig.json');

module.exports = {
    '@tags': ['returningFlightTestNewZealand'],
    ...
    ;
        ...
        browser.saveScreenshot('tests_output/screenshots/newZealand/ReturningFlightTestNewZealand.png');
    }
};