//  To test this content ->  npm tag test : npm test -- --tag departureFlightTestNewZealand

const DefaultConfig = require('../DefaultConfig.json');

module.exports = {
    '@tags': ['departureFlightTestNewZealand'],
    'Luxury Escapes Departure Flight Test NewZealand'(browser) {
    ...
    ;
        ...
        browser.saveScreenshot('tests_output/screenshots/newZealand/DepartureFlightTestNewZealand.png');
    }
};