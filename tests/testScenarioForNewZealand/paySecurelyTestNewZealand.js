//  To test this content ->  npm tag test : npm test -- --tag paySecurelyTestNewZealand

const DefaultConfig = require('../DefaultConfig.json');

module.exports = {
    '@tags': ['paySecurelyTestNewZealand'],
    'Luxury Escapes Pay Securely Test NewZealand'(browser) {
